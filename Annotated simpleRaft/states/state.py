...
# Import the class BaseMessage from the folder ../messages/base
from ..messages.response import ResponseMessage
# Import the class ResponseMessage from the folder ../messages/base

class State(object):
# Define a class called State

    def set_server(self, server):
        # self: The object being passed to this function
        self._server = server
    ...
    def on_message(self, message):
        ...
        # The underscore notation prepended before variables is a notation for denoting that
        ...
        ##  them this so they don't get left behind.
            ...
            # yes = False means that the request (for which this is the response)
            # is rejected
            return self, None
    ...
    def _nextTimeout(self):
        ...
        # Return the time in seconds since the epoch (the point where the time starts) as a floating point number.
