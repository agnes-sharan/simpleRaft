...
class Follower(Voter):
    ...
    def on_append_entries(self, message):
        ...
        # Technically, timeout should be reset after this if statement
        ...
        if(message.data != {}):
            ...
            # If the log is smaller than the prevLogIndex
            ...
            # If the term number at prevLogIndexfor this server and the leader
            # are different:
            if(len(log) > 0 and
